class Rope
  ...
  //create multiple rectangular bodies to form a chain
...
//create the chain of rectangles
  ...
  World.add(engine.world, this.body);
    ...
    //break is breaking the chain, null is nothing is attached 
    break() 
